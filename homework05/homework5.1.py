...
filtred_dict = {}
count = 0
for name, i in car_data.items():
  if i[1] >= 2017 and i[2] >= 1.6 and i[4] <= 36000:
    filtred_dict[name] = i
sorted_cars = sorted(filtred_dict.items(), key=lambda x: x[1][4])
for name, i in sorted_cars[0:5]:
  print(name, i)